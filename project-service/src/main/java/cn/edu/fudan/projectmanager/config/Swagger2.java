...
public class Swagger2 {
    ...
    private static final String DEFAULT_PATH = "/project-swagger";
    private static final String CONTROLLER_PACKAGE = "cn.edu.fudan.projectmanager.controller";
    private static final String TITLE = "code wisdom project-service Api";
    private static final String DOC_DES = "code wisdom project-service api doc";
    private static final String VISIT_URL = "http://10.176.34.85:8002/";
    private static final String EMAIL = "pyu@fudan.edu.cn";

    private static final String USER_TOKEN = "ec15d79e36e14dd258cfff3d48b73d35";
    ...
    public Docket createRestApi() {
        ...
        ticketPar.name("token").description("Http headers token字段")
                ...
                .defaultValue(USER_TOKEN).required(false).build();
