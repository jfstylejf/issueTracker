// Generated from C:/work/IssueTracker-Master/measure-service/src/main/java/cn/edu/fudan/measureservice/parser/Cpp\CPP14Parser.g4 by ANTLR 4.9.1
...
public class CPP14Parser extends Parser {
	 ...
	 *  跳过解析方法体内部的信息
	 */
	private void jumpOverStatement() {
		// 消耗左括号
		match(LeftBrace);
		setState(869);
		_errHandler.sync(this);
	...
	public final DeclarationContext declaration() throws RecognitionException {
		...
		try {
			...
			if (_la == 21) {
				...
				flag = getInterpreter().adaptivePredict(_input,96,_ctx);
			}
			switch ( flag ) {
			case 1:
				enterOuterAlt(_localctx, 1);
	...
	private void exceptionStatementHandler() {
		int _la = _input.LA(1);
		match(_la);
		// 消耗左圆括号
		_la = _input.LA(1);
