...
public class Swagger {
    ...
    public static class Swagger2 {
        ...
        private static final String DEFAULT_PATH = "/measure-swagger";
        private static final String CONTROLLER_PACKAGE = "cn.edu.fudan.measureservice.controller";
        private static final String TITLE = "code wisdom measure-service Api";
        private static final String DOC_DES = "code wisdom Measure-service api doc";
        private static final String VISIT_URL = "http://10.176.34.85:8888/";
        private static final String EMAIL = "zwj@fudan.edu.cn";
