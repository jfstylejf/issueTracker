...
public class Swagger2 {
    ...
    private static final String CONTROLLER_PACKAGE = "cn.edu.fudan.dependservice.controller";
    private static final String TITLE = "code wisdom dependency Api";
    private static final String DOC_DES = "code wisdom Dependency-service api doc";
    private static final String VISIT_URL = "http://10.176.34.85:8999/";
    private static final String EMAIL = "shaox19@fudan.edu.cn";
