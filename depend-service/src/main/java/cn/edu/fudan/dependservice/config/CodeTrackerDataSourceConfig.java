 ...
 */
@Configuration
@MapperScan(basePackages = "cn.edu.fudan.codetracker.mapper", sqlSessionTemplateRef = "codeTrackerSqlSessionTemplate")
public class CodeTrackerDataSourceConfig {
    ...
    public SqlSessionFactory sessionFactory(@Qualifier("codeTrackerDataSource") DataSource dataSource) throws Exception {
        ...
        factoryBean.setMapperLocations(
                new PathMatchingResourcePatternResolver().getResources("classpath:cn/edu/fudan/codetracker/mapper/*.xml"));
