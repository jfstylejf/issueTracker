...
public class RawIssueMatcherTest {
    ...
    public void singleLocationAddLineMatchTest() {
        ...
        Set<String> curName = new HashSet<>();
        curName.add("addLineTest()");
     ...
     */
    @Test
    public void singleLocationDelLineMatchTest() {
     ...
     */
    @Test
    public void singleLocationMethodNameMatchTest() {
        ...
        Set<String> curName = new HashSet<>();
        curName.add("MethodNameChange()");
        curName.add("MethodNameChange2(int)");
