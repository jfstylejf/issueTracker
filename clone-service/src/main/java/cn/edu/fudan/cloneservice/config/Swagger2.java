...
public class Swagger2 {
    ...
    private static final String DEFAULT_PATH = "/clone-swagger";
    private static final String CONTROLLER_PACKAGE = "cn.edu.fudan.cloneservice.controller";
    private static final String TITLE = "code wisdom clone-service Api";
    private static final String DOC_DES = "code wisdom clone-service api doc";
